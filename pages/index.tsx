  ...
  return (
    <>
        ...
        <div className='flex items-center flex-wrap font-medium text-lg flex items-center'>
            ...
            <span className='animate-bounce bg-clip-text text-transparent dark:text-transparent bg-gradient-to-r from-purple-500 dark:from-purple-400 via-pink-500 dark:via-pink-500 to-red-600 dark:to-red-600'>fullstack developer</span>&nbsp;
            <p>and</p>&nbsp;
            <span className='animate-bounce bg-clip-text text-transparent dark:text-transparent bg-gradient-to-r from-green-600 dark:from-green-500 to-blue-500 dark:to-blue-500'>student</span>
        </div>
        <p className='py-1'>
