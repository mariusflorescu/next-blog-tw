    ...
    return (
        <div className='relative group cursor-pointer'>
            <div className='flex'>
                ...
                <h1 className='transition-all duration-500 text-5xl font-bold transform group-hover:translate-x-4 text-opacity-0 dark:text-opacity-0 group-hover:text-opacity-100'>arius</h1>
            </div>
