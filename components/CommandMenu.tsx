                                ...
                                <div className='max-h-80 overflow-y-scroll'>
                                    ...
                                    <div
                                        ...
                                        <div className='font-mono text-sm flex items-center gap-3'>
                                            <svg className='w-5 h-5 fill-current text-black dark:text-white' viewBox="0 0 256 250" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                                <g>
