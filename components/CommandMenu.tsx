...
const Category: React.FC<{ name: string }> = ({ name }) => {
  return (
    <div className="font-mono text-xs py-1 px-6 bg-gray-100 dark:bg-gray-800">
      {name}
    </div>
  );
};
...
const CommandMenu = () => {
  ...
  const keymaps = useMemo(() => {
    return {
      ...
      "s l": () =>
        window.open(
          "https://www.linkedin.com/in/marius-adrian-florescu-141aaa209/",
          "_blank"
        ),
    };
      ...
      <Transition appear show={open} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 z-10" onClose={closeModal}>
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-full max-w-xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl dark:bg-gray-900">
                <Dialog.Title className="font-mono px-6 py-4 border-b border-gray-200 dark:border-gray-900 text-lg font-semibold">
                  command menu
                </Dialog.Title>
                ...
                <div className="max-h-80 overflow-y-scroll">
                  ...
                  <div
                    ...
                    className="font-mono text-sm flex items-center justify-between transition-all cursor-pointer py-2 px-12 hover:bg-gray-100 dark:hover:bg-gray-800 group"
                  >
                  ...
                  <Link href="/" passHref>
                    <div className="font-mono text-sm flex items-center justify-between transition-all cursor-pointer py-2 px-12 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                      <span>home</span>
                      <span className="py-1 px-2 font-mono rounded bg-gray-100 dark:bg-gray-700 group-hover:bg-white dark:group-hover:bg-gray-900">
                        G+H
                      </span>
                  ...
                  <div
                    onClick={() =>
                      window.open("https://github.com/mariusflorescu", "_blank")
                    }
